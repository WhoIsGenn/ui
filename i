...
local function Notify(title, content, duration)
    ...
    task.spawn(function()
        pcall(function()
            ...
            local gui = parent:FindFirstChild("VictoriaHub_Notifications")
            if not gui then
                gui = Instance.new("ScreenGui")
                gui.Name = "VictoriaHub_Notifications"
...
function System.autoparry.start()
    ...
    System.__properties.__connections.__autoparry=RunService.PreSimulation:Connect(function()
        ...
        for _,ball in pairs(balls) do
            ...
            local speed=velocity.Magnitude
            -- ping compensation: scale clamp tighter at low speed, looser at high speed
            local ping_threshold=math.clamp(ping/10, 5, 17 + math.min(speed*0.012, 8))
            -- speed_divisor: soften at high speed so base_accuracy grows with ball velocity
            local capped_speed_diff=math.min(math.max(speed-9.5,0),850)
            local speed_divisor_base=2.4+capped_speed_diff*0.0016   -- was 0.002, lower = wider window
            ...
            -- extra flat bonus that scales with speed to catch fast balls earlier
            local speed_bonus=math.clamp((speed-200)*0.008, 0, 14)
            local range_bonus=(System.__properties.__parry_range_offset/10)*base_accuracy
            local parry_accuracy=ping_threshold+base_accuracy+speed_bonus+range_bonus
        ...
        if training_ball then
            ...
            if zoomies then
                ...
                if not System.__properties.__training_parried then
                    ...
                    local ping_threshold=math.clamp(ping/10, 5, 17 + math.min(speed*0.012, 8))
                    local capped_speed_diff=math.min(math.max(speed-9.5,0),850)
                    local speed_divisor_base=2.4+capped_speed_diff*0.0016
                    local speed_divisor=speed_divisor_base*System.__properties.__divisor_multiplier
                    local base_accuracy=math.max(speed/speed_divisor,9.5)
                    local speed_bonus=math.clamp((speed-200)*0.008, 0, 14)
                    local range_bonus=(System.__properties.__parry_range_offset/10)*base_accuracy
...
AutoParryGroup:create_dropdown("VictoriaHub_AutoParry_Mode", {
    title = "Parry Mode",
...
CurveUIGroup:create_toggle("VictoriaHub_CurveUI", {
    title = "Curve UI",
    default = false,
    callback = function(state)
        if state then
...
CurveUIGroup:create_toggle("VictoriaHub_CurveUI_Random", {
    title = "Random Curve",
    default = false,
    callback = function(state)
        if state then
...
AutoParryGroup:create_slider("VictoriaHub_AutoParry_Accuracy", {
    title = "Accuracy",
    minimum = 1,
    maximum = 100,
    default = 50,
...
AutoParryGroup:create_slider("VictoriaHub_AutoParry_Range", {
    title = "Parry Range",
    minimum = 0,
    maximum = 10,
    default = 0,
...
AutoParryGroup:create_toggle("VictoriaHub_AutoParry_RandomAccuracy", {
...
AutoParryGroup:create_toggle("VictoriaHub_AutoParry_AutoAbility", {
    title = "Auto Ability",
    default = false,
    callback = function(state)
...
KeyboardGroup:create_toggle("VictoriaHub_Keyboard_ShowUI", {
    title = "Keyboard",
    default = false,
    callback = function(state)
        if state then
...
TriggerbotGroup:create_toggle("VictoriaHub_Triggerbot", {
    title = "Triggerbot",
    default = false,
    callback = function(state)
...
AutoSpamGroup:create_toggle("VictoriaHub_AutoSpam", {
    title = "Auto Spam",
    default = false,
    callback = function(state)
        System.__properties.__auto_spam_enabled = state
...
AutoSpamGroup:create_dropdown("VictoriaHub_AutoSpam_Mode", {
    title = "Spam Mode",
    options = {"Remote", "Keypress"},
    default = "Remote",
    callback = function(value)
...
AutoSpamGroup:create_toggle("VictoriaHub_AutoSpam_AnimationFix", {
    title = "Animation Fix",
    default = true,
    callback = function(state)
...
AutoSpamGroup:create_toggle("VictoriaHub_AutoSpam_Notify", {
    title = "Notify",
    default = false,
    callback = function(state)
...
AutoSpamGroup:create_slider("VictoriaHub_AutoSpam_Rate", {
    title = "Spam Rate",
    minimum = 60,
    maximum = 5000,
    default = 240,
...
ManualSpamGroup:create_toggle("VictoriaHub_ManualSpam_ShowUI", {
...
ManualSpamGroup:create_dropdown("VictoriaHub_ManualSpam_Mode", {
    title = "Spam Mode",
    options = {"Remote", "Keypress"},
    default = "Remote",
    callback = function(value)
...
ManualSpamGroup:create_toggle("VictoriaHub_ManualSpam_AnimationFix", {
    title = "Animation Fix",
    default = true,
    callback = function(state)
...
-- ══ VISUAL TAB: Unlock All (moved from Unlock tab) ══
local VisualUnlockGroup = Visual:create_group("Unlock", "left")
VisualUnlockGroup:create_toggle("unlock_all_visual", {
    title = "Unlock All",
    default = false,
    callback = function(state)
...
-- ══ VISUAL TAB: UI groups for new features ══
local VisualGraphicsGroup = Visual:create_group("Graphics", "right")
VisualGraphicsGroup:create_toggle("kk_low_graphics", {
    title = "Low Graphics Mode",
    default = false,
    callback = function(value) _kApplyLowGraphics(value) end,
})

local VisualAppearanceGroup = Visual:create_group("Appearance", "left")
VisualAppearanceGroup:create_button({
...
local VisualSkinGroup = Visual:create_group("Skin Changer", "right")
VisualSkinGroup:create_toggle("kk_skin_changer", {
    title = "Skin Changer",
    default = false,
    callback = function(value)
...
VisualSkinGroup:create_textbox("kk_sword_name", {
    title = "Sword Name",
...
NoRenderGroup:create_toggle("VictoriaHub_Misc_NoRender", {
    title = "No Render",
    default = false,
    callback = function(state)
...
EmotesGroup:create_toggle("VictoriaHub_Misc_Emotes", {
    title = "Emotes",
    default = false,
    callback = function(value)
...
EmotesGroup:create_toggle("VictoriaHub_Misc_Emotes_AutoStop", {
    title = "Auto Stop",
    default = false,
    callback = function(value)
...
EmotesGroup:create_dropdown("VictoriaHub_Misc_Emotes_Selected", {
    title = "Emote Type",
    options = emotes_data,
...
FOVGroup:create_toggle("VictoriaHub_Misc_FOV", {
    title = "FOV",
    default = false,
    callback = function(value)
...
FOVGroup:create_slider("VictoriaHub_Misc_FOV_Value", {
...
CharacterGroup:create_toggle("VictoriaHub_Misc_Character", {
    title = "Character",
    default = false,
    callback = function(value)
...
CharacterGroup:create_toggle("VictoriaHub_Misc_Character_InfiniteJump", {
    title = "Infinite Jump",
    flag = "VictoriaHub_Misc_Character_InfiniteJump",
    callback = function(value)
        CharacterBackendSetInfiniteJump(value)
    end
})

CharacterGroup:create_toggle("VictoriaHub_Misc_Character_Spin", {
    title = "Spin",
    flag = "VictoriaHub_Misc_Character_Spin",
    callback = function(value)
...
CharacterGroup:create_slider("VictoriaHub_Misc_Character_SpinSpeed", {
    title = 'Spin Speed',
    flag = 'VictoriaHub_Misc_Character_SpinSpeed',
    maximum = 50,
    minimum = 1,
    default = 5,
    rounding = true,
...
CharacterGroup:create_toggle("VictoriaHub_Misc_Character_WalkSpeed", {
    title = "Walk Speed",
    flag = "VictoriaHub_Misc_Character_WalkSpeed",
    callback = function(value)
...
CharacterGroup:create_slider("VictoriaHub_Misc_Character_WalkSpeedValue", {
    title = 'Walk Speed Value',
    flag = 'VictoriaHub_Misc_Character_WalkSpeedValue',
    maximum = 500,
    minimum = 16,
    default = 36,
    rounding = true,
...
CharacterGroup:create_toggle("VictoriaHub_Misc_Character_JumpPower", {
    title = "Jump Power",
    flag = "VictoriaHub_Misc_Character_JumpPower",
    callback = function(value)
...
CharacterGroup:create_slider("VictoriaHub_Misc_Character_JumpPowerValue", {
    title = 'Jump Power Value',
    flag = 'VictoriaHub_Misc_Character_JumpPowerValue',
    maximum = 200,
    minimum = 50,
    default = 50,
    rounding = true,
...
CharacterGroup:create_toggle("VictoriaHub_Misc_Character_Gravity", {
    title = "Gravity",
    flag = "VictoriaHub_Misc_Character_Gravity",
    callback = function(value)
...
CharacterGroup:create_slider("VictoriaHub_Misc_Character_GravityValue", {
    title = 'Gravity Value',
    flag = 'VictoriaHub_Misc_Character_GravityValue',
    maximum = 400.0,
    minimum = 0,
    default = 196.2,
    rounding = true,
...
CharacterGroup:create_toggle("VictoriaHub_Misc_Character_HipHeight", {
    title = "Hip Height",
    flag = "VictoriaHub_Misc_Character_HipHeight",
    callback = function(value)
...
CharacterGroup:create_slider("VictoriaHub_Misc_Character_HipHeightValue", {
    title = 'Hip Height Value',
    flag = 'VictoriaHub_Misc_Character_HipHeightValue',
    maximum = 20,
    minimum = -5,
    default = 0,
    rounding = true,
...
ImmortalGroup:create_toggle("VictoriaHub_immortal", {

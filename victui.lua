...
return function(ks, GuiConfig, CoreGui, TweenService, getIconId)
    ...
    local Title = Instance.new("TextLabel")
    Title.Font = Enum.Font.GothamBold
    Title.Text = (ks.Title or GuiConfig.Title or "VelarisUI") .. " — Key System"
    Title.TextSize = 16
    Title.TextColor3 = Color3.fromRGB(255, 255, 255)
    Title.BackgroundTransparency = 1
    Title.TextXAlignment = Enum.TextXAlignment.Left
    ...
    Note.Text = (ks.Note and tostring(ks.Note)) or ("Masukkan key dari " .. providerName .. " buat lanjut.")
    Note.TextSize = 13
    Note.TextColor3 = Color3.fromRGB(255, 255, 255)
    Note.TextTransparency = 0.35
    Note.TextWrapped = true
    Note.TextXAlignment = Enum.TextXAlignment.Left
    Note.TextYAlignment = Enum.TextYAlignment.Top
    Note.BackgroundTransparency = 1
    Note.Position = UDim2.new(0, 16, 0, 40)
    Note.Size = UDim2.new(1, -32, 0, 40)
    Note.Parent = Card
    ...
    KeyBox.BackgroundTransparency = 0.92
    KeyBox.Position = UDim2.new(0, 16, 0, 88)
    ...
    GetKeyBtn.BackgroundTransparency = 0.9
    GetKeyBtn.Position = UDim2.new(0, 16, 1, -50)
    GetKeyBtn.Size = UDim2.new(0.5, -20, 0, 36)
    GetKeyBtn.Visible = hasCopyLink
    ...
    SubmitBtn.Position = hasCopyLink and UDim2.new(0.5, 4, 1, -50) or UDim2.new(0, 16, 1, -50)
    SubmitBtn.Size = hasCopyLink and UDim2.new(0.5, -20, 0, 36) or UDim2.new(1, -32, 0, 36)
    ...
    GetKeyBtn.MouseButton1Click:Connect(function()
        local ok2, err = pcall(provider.Copy)
        StatusLabel.TextColor3 = Color3.fromRGB(120, 200, 255)
        StatusLabel.Text = (ok2 and setclipboard) and "Link disalin ke clipboard." or "Nggak bisa nyalin link (executor nggak support setclipboard)."
    end)
    ...
    SubmitBtn.MouseButton1Click:Connect(function()
        ...
        if isValid then
            ...
            StatusLabel.Text = msg or "Key valid!"
            verified = true
            task.wait(0.4)
            destroyed = true
            ScreenGui:Destroy()
            ...
            StatusLabel.TextColor3 = Color3.fromRGB(255, 120, 120)
            StatusLabel.Text = msg or "Key tidak valid."
            SubmitBtn.Text = "Submit"
        end
    end)

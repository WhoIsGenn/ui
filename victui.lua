...
function Victoriahub:MakeNotify(NotifyConfig)
    ...
    NotifyConfig.Color = NotifyConfig.Color or Color3.fromRGB(100, 150, 255)
    ...
    spawn(function()
        ...
        if not CoreGui.NotifyGui:FindFirstChild("NotifyLayout") then
            ...
            NotifyLayout.Position = UDim2.new(1, -15, 1, -15)
        ...
        NotifyFrameReal.BackgroundColor3 = Color3.fromRGB(25, 25, 28)
        ...
        TitleLabel.Size = UDim2.new(1, -45, 0, 14)
        ...
        DescLabel.Position = UDim2.new(0, TitleLabel.TextBounds.X + 14, 0, 4)
        DescLabel.Size = UDim2.new(1, -TitleLabel.TextBounds.X - 55, 0, 14)
        ...
        ContentLabel.Size = UDim2.new(1, -15, 0, 14)
        ...
        local maxLines = 2
        local lineHeight = 11
        local textHeight = math.min(math.ceil(ContentLabel.TextBounds.X / ContentLabel.AbsoluteSize.X) * lineHeight, maxLines * lineHeight)
        ContentLabel.Size = UDim2.new(1, -15, 0, textHeight)
        
        NotifyFrame.Size = UDim2.new(1, 0, 0, 50)

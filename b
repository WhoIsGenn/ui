...
-- ── Auto Parry ──
local AutoParrySec = CombatTab:AddSection({ Title = "Auto Parry" })
...
-- ── Curve UI ──
local CurveUISec = CombatTab:AddSection({ Title = "Curve UI" })
...
-- ── Keyboard ──
local KeyboardSec = CombatTab:AddSection({ Title = "Keyboard" })
...
-- ── Triggerbot ──
local TriggerbotSec = CombatTab:AddSection({ Title = "Triggerbot" })
...
-- ── Detection ──
local DetectSec = CombatTab:AddSection({ Title = "Detection" })
...
-- ── Auto Spam ──
local AutoSpamSec = CombatTab:AddSection({ Title = "Auto Spam" })
...
-- ── Manual Spam ──
local ManualSpamSec = CombatTab:AddSection({ Title = "Manual Spam" })
...
local ImmortalSec = Immortal:AddSection({ Title = "Immortal" })
...
local WorldSkyChangerSec = World:AddSection({ Title = "Sky Changer" })
...
local VisualUnlockSec = Visual:AddSection({ Title = "Unlock" })
...
local VisualGraphicsSec = Visual:AddSection({ Title = "Graphics" })
...
local VisualAppearanceSec = Visual:AddSection({ Title = "Appearance" })
...
local VisualSkinSec = Visual:AddSection({ Title = "Skin Changer" })
...
local VisualLeft = Visual:AddSection({ Title = "Ability ESP" })
do
    local Visual_Data = {}
...
local VisualRight = Visual:AddSection({ Title = "Ball Statistic" })
do
...
-- ── No Render ──
local NoRenderSec = MiscTab:AddSection({ Title = "No Render" })
...
-- ── Emotes ──
local EmotesSec = MiscTab:AddSection({ Title = "Emotes" })
EmotesSec:AddToggle({
...
-- ── FOV ──
local FOVSec = MiscTab:AddSection({ Title = "FOV" })
FOVSec:AddToggle({
...
-- ── Character ──
local CharacterSec = MiscTab:AddSection({ Title = "Character" })

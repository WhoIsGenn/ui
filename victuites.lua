...
function SaveConfig(name)
    ...
    task.spawn(function()
        ...
        if writefile then
            ...
            if not success then
                warn("[VictUI] Config save error:", err)
            end
        end
        SaveDebounce = false
    end)
            ...
            pcall(function()
                if targetValue ~= nil then
                    ...
                    elseif element.Type == "Slider" then
                        element:Set(element.Default or 0, true)
                    elseif element.Type == "Dropdown" then
                        element:Set(element.Default or "", true)
        ...
        function Sections:AddSection(Title, AlwaysOpen)
            ...
            function Items:AddToggle(ToggleConfig)
                ...
                function ToggleFunc:Set(Value, silent)
                    ...
                    if not silent and not isInCallback then
                        isInCallback = true
            ...
            function Items:AddDropdown(DropdownConfig)
                ...
                function DropdownFunc:SetValues(newList, selecting)
                    ...
                    DropdownFunc:Set(selecting, false)
                end
                
                -- Alias for SetValues (easier to remember)

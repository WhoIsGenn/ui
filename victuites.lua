...
local ConfigFile = "Victoriahub/Config/Victoriahub_" .. gameName .. ".json"
...
function Vict(msg, delay, color, title, desc)
...
function Victoriahub:Window(GuiConfig)
    ...
    GuiConfig.Footer = GuiConfig.Footer or "Victoriahub"
    ...
    VictoriahubUI.Name = "Victoriahub"
    VictoriahubUI.ResetOnSpawn = false
    VictoriahubUI.Parent = game:GetService("CoreGui")
    ...
    local VictoriahubButton = Instance.new("ScreenGui")
    local Button = Instance.new("ImageButton")
    local Corner = Instance.new("UICorner")
    local Scale = Instance.new("UIScale")

    StreeHubButton.Name = "VictoriahubButton"
    ...
    Button.Name = 'Victoriahub'
    Button.Parent = VictoriahubButton

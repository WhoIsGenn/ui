...
-- Crosshair
local CrossH = Drawing.new("Line")  -- horizontal
CrossH.Thickness = 1.5
CrossH.Color = Color3.fromRGB(255, 255, 255)
CrossH.Transparency = 1
CrossH.Visible = false

local CrossV = Drawing.new("Line")  -- vertical
CrossV.Thickness = 1.5
CrossV.Color = Color3.fromRGB(255, 255, 255)
CrossV.Transparency = 1
CrossV.Visible = false

local CrossDot = Drawing.new("Circle")  -- dot tengah
CrossDot.Radius = 2
...
local function MainLoop()
    ...
    if Config.AIM_Crosshair then
        ...
        local sz = 10  -- panjang garis
        local gap = 3  -- gap di tengah
        CrossH.From = Vector2.new(cx - sz - gap, cy)
        CrossH.To   = Vector2.new(cx - gap, cy)
        CrossH.Visible = true
        -- buat 2 segment horizontal
        CrossV.From = Vector2.new(cx, cy - sz - gap)
        CrossV.To   = Vector2.new(cx, cy - gap)
        CrossV.Visible = true

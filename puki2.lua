...
local function UpdateParryFOV()
    ...
    -- Posisi circle di LANTAI (pake Y yang pasti)
    -- Coba cari lantai pake raycast, kalo gagal pake root.Y - 3
    local groundY = root.Y - 3.2
    ...
    -- Debug: print posisi biar tau
    -- print("Circle Pos:", circlePos.Y, "OnScreen:", onScreen)
    ...
    if onScreen then
        ...
        -- FALLBACK: kalo ga onScreen, coba pake posisi root (di badan)
        -- Biar tetap keliatan walau ga sempurna
        local fallbackPos = root.Position + Vector3.new(0, -2, 0)

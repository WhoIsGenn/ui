...
local Window = VelarisUI:Window({
    Title = "Violence District ", -- Main title displayed at the top of the window
    Footer = "Victoria Hub", -- Footer text shown at the bottom
    Content = "Content",
    ...
    Configname = "Victoria_Ui", -- Configuration file name for saving settings

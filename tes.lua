...
-- Compat layer: Brigida tidak pakai Toggles/Options global
-- Kita buat sendiri agar game logic tetap jalan
local _flags = {}
...
-- Override AddSliderToggle ke Brigida syntax (dipanggil setelah S.* sections dibuat)
-- Forward-declare, akan di-override di UI section
local _astQueue = {}
function AddSliderToggle(cfg)
    -- Akan di-handle di UI section, simpan cfg dulu
    table.insert(_astQueue, cfg)
end

-- Override CreateSwitchGroup (akan di-override di UI section juga)
function CreateSwitchGroup(sec, id, displayName, tableSource)
    -- Placeholder - akan di-override di UI section
end

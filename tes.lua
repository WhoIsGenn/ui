                        ...
                        pcall(function()
                            ...
                            if not cancelSuccess then
                                while not cancelSuccess do
                                    local retry = Remotes.Cancel:InvokeServer()
                            ...
                            if not chargeSuccess then
                                while not chargeSuccess do
                                    local retry = Remotes.Charge:InvokeServer(tick())
                                    if retry then break end
                                    task.wait(0.05)
                                end
                            end
                            
                            Remotes.StartMinigame:InvokeServer(-1.233184814453125, 0.9965292652011685)
                        end)
                    end)

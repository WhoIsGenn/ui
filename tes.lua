    ...
    pcall(function()
        ...
        if healEvent and healAnimRec then
            ...
            HealConn = healEvent.OnClientEvent:Connect(function()
                ...
                if GetRole() ~= "Survivor" then return end
                -- Fire HealAnimRec beberapa kali untuk instant complete
                for i = 1, 5 do
...
local function InstantHealOther_Setup()
    pcall(function()
        ...
        if healEvent and healAnimRec then
            ...
            HealOtherConn = healEvent.OnClientEvent:Connect(function()

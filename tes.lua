...
D(secBoss, "SelectedBosses",     { Text = "Select Bosses",       Values = Tables.BossList,        Multi = true  })
...
D(secFarmCfg, "SelectedMovementType", { Text = "Select Movement Type", Values = { "Teleport", "Tween" }, Default = "Tween" })
D(secFarmCfg, "SelectedFarmType",     { Text = "Select Farm Type",     Values = { "Behind", "Above", "Below" }, Default = "Behind" })

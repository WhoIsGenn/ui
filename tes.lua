...
local IslandCrystals = {
    ...
    ["BizarreIsland"] = workspace:FindFirstChild("BizarreIsland") and workspace.BizarreIsland:FindFirstChild("SpawnPointCrystal_Bizarre"),
     ["Slayer Island"] = workspace:FindFirstChild("SlayerIsland") and workspace.SlayerIsland:FindFirstChild("SpawnPointCrystal_Slayer"), 
     ["Blue Planet Island"] = workspace:FindFirstChild("BluePlanetIsland") and workspace.BluePlanetIsland:FindFirstChild("SpawnPointCrystal_Slayer"),  
     ["Starter Island Sea2"] = workspace:FindFirstChild("StarterIsland_Sea2") and workspace.StarterIsland_Sea2:FindFirstChild("SpawnPointCrystal_Startsea2"), 
     ["World Island"] = workspace:FindFirstChild("WorldIsland") and workspace.WorldIsland:FindFirstChild("SpawnPointCrystal_World"),          
     ["Punch Island"] = workspace:FindFirstChild("PunchIsland") and workspace.PunchIsland:FindFirstChild("SpawnPointCrystal_Punch"),               

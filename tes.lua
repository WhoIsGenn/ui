...
local function buildMonitor()
    ...
    ft.BackgroundTransparency=1 ft.Text="v37.0  •  Auto SK"
...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- DRAG FUNCTIONALITY (kayak contoh)
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
local function rebuildList(prefix)
    ...
    for idx, word in ipairs(words) do
        ...
        -- Kata (bold hijau seperti screenshot)
        local wordLbl=Instance.new("TextLabel",row)
        wordLbl.Size=UDim2.new(0,110,0,20) wordLbl.Position=UDim2.new(0,10,0,5)
        wordLbl.BackgroundTransparency=1 wordLbl.Text=word
        wordLbl.TextColor3=Color3.fromRGB(80,220,120) wordLbl.TextSize=12
...
local function buildManual()
    ...
    sbg.Size=UDim2.new(1,-20,0,32) sbg.Position=UDim2.new(0,10,0,70)
    ...
    sbox:GetPropertyChangedSignal("Text"):Connect(function()
        ...
        if #q>=1 then
            ...
            task.spawn(function() rebuildList("") end)
        end
    end)
end
...
print("[SK] v37.0 | No Heartbeat scan | SK Manual panel")
WindUI:Notify({Title="Auto SK v37.0",Content="Loading KBBI...",Icon="zap",Duration=3})

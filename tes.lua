...
-- ================================================================
-- ROLE MANAGER - variabel dideklarasikan di sini,
-- fungsi-fungsinya didefinisikan SETELAH semua dependencies (lihat bawah)
-- ================================================================
...
-- ================================================================
-- ROLE MANAGER - fungsi (didefinisikan setelah semua dependencies)
-- ================================================================
...
-- Handle: role change Spectator→Match, ATAU respawn dalam match
local function RehookForRole(char, role)
    ...
    -- Semua role
    if Config.GODMODE then task.spawn(Godmode_Apply) end
...
local function RoleManager_Start()
    ...
    RoleManagerConn = LocalPlayer:GetPropertyChangedSignal("Team"):Connect(function()
        ...
        if newRole == "Spectator" then
            ...
            -- Delay untuk tunggu Character dan GUI di-setup game

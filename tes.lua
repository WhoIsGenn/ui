...
-- ================================================================
-- PARRY FOV CIRCLE (DARI TESVIDE.LUA)
-- ================================================================
...
local function Init()
    ...
    VelarisUI:MakeNotify({ Title = "Victoria Hub", Description = "Loaded Successfully!", Color = "Success", Time = 3 })
end

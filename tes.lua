                    ...
                    if typeof(gun) == "Instance" and typeof(direction) == "Vector3" then
                        ...
                        if target and target.Character and myRoot then
                            ...
                            if aimPart then
                                ...
                                local newDir = (aimPart.Position - origin).Unit

                                -- Simpan CFrame asli
                                local originalCFrame = cam.CFrame
                                -- Set camera ke arah target sesaat
                                cam.CFrame = CFrame.new(origin, origin + newDir)

                                -- Fire dengan camera yang sudah diarahkan ke target
                                -- Fire normal, camera sudah diarahkan ke target
                                oldNamecall(...)

                                -- Restore CFrame setelah fire

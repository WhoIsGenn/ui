...
secSilentAim:AddDropdown({
    Title = "Aim Target",
    Values = {"Killer", "Survivor", "Closest"},
...
secSilentAim:AddDropdown({
    ...
    Values = {"Head", "HumanoidRootPart", "UpperTorso", "LowerTorso", "Torso", "LeftUpperArm", "RightUpperArm", "LeftUpperLeg", "RightUpperLeg"},

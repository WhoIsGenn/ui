...
-- ==================== BLATANT V3 ====================
local blatantV3Section = Tab3:AddSection("Blatant V3 (Pure Aggressive)")
...
-- ==================== AUTO CAST (RANDOM PERFECT) ====================
local function AutoCast()
    local power = -1.23 + (math.random(-30,30) / 1000)

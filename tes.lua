...
SecESPPlayers:AddToggle({ Title = "Skeleton", Default = Config.ESP_Skeleton, Callback = function(v) Config.ESP_Skeleton = v end })
...
SecESPPlayers:AddToggle({ Title = "Velocity", Default = Config.ESP_Velocity, Callback = function(v) Config.ESP_Velocity = v end })

-- Objects Section
local SecESPObjects = Tabs.ESP:AddSection({ Title = "Objects", Open = false })

SecESPObjects:AddToggle({ Title = "Generator", Default = Config.ESP_Generator, Callback = function(v) Config.ESP_Generator = v end })
SecESPObjects:AddToggle({ Title = "Gate", Default = Config.ESP_Gate, Callback = function(v) Config.ESP_Gate = v end })
SecESPObjects:AddToggle({ Title = "Hook", Default = Config.ESP_Hook, Callback = function(v) Config.ESP_Hook = v end })
SecESPObjects:AddToggle({ Title = "Pallet", Default = Config.ESP_Pallet, Callback = function(v) Config.ESP_Pallet = v end })
SecESPObjects:AddToggle({ Title = "Window", Default = Config.ESP_Window, Callback = function(v) Config.ESP_Window = v end })
...
SecRadar:AddToggle({ Title = "Circle Shape", Default = Config.RADAR_Circle, Callback = function(v) Config.RADAR_Circle = v end })
...
-- Camera
local SecKillCamera = Tabs.KILLER:AddSection({ Title = "Camera", Open = false })
SecKillCamera:AddToggle({ Title = "Third Person", Default = Config.CAM_ThirdPerson, Callback = function(v) Config.CAM_ThirdPerson = v end })

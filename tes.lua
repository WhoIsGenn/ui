...
local function DungeonAutofarm()
    ...
    local finalPos = tPos - direction * distance
    
    if (finalPos - tPos).Magnitude < 3 then
        finalPos = tPos - direction * 5
    end
    
    local finalDestination = CFrame.lookAt(finalPos, tPos)
...
-- ============================================================
-- UNIFIED DUNGEON LOOP (satu loop untuk semua dungeon)
-- ============================================================
-- ============================================================
...
task.spawn(function()
    while getgenv().Gennskie_Running do
        ...
        -- INFINITE TOWER (langsung cek toggle AutoJoinPortal_IT, AutoStartWave_IT, AutoReplay_IT, DungeonAutofarm_IT)
        ...
        -- CRYSTAL DEFENSE (langsung cek toggle masing-masing)

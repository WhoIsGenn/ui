...
-- Gunakan 'net' yang sudah didefinisikan di atas, JANGAN buat baru
...
local ReelDelayV3 = 0.7    -- Simpan lokal, jangan pakai _G
local CompleteDelayV3 = 0.3
...
local function startV3Loop()
    ...
    heartbeatConnection = RunService.Heartbeat:Connect(function(deltaTime)
        ...
        local reelEvery = math.max(1, math.floor(ReelDelayV3 / deltaTime))
        local completeEvery = math.max(1, math.floor(CompleteDelayV3 / deltaTime))
        ...
        -- Cleanup setiap 600 frames (~10 detik)

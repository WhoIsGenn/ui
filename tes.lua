-- ==========================================
-- || ArcX AutoFarm - VictUI Version
-- || Original: Fluent UI → Converted: VictUI
-- ==========================================
...
local TabMobs     = Window:AddTab({ Name = "Entities", Icon = "swords"   })
local TabBosses   = Window:AddTab({ Name = "Bosses",   Icon = "skull"    })
local TabSpecials = Window:AddTab({ Name = "Specials", Icon = "star"     })
local TabCrafting = Window:AddTab({ Name = "Crafting", Icon = "hammer"   })
local TabMisc     = Window:AddTab({ Name = "Misc",     Icon = "gift"     })
        ...
        if v then
            for _, player in ipairs(Players:GetPlayers()) do
                if player ~= LocalPlayer then
                    ...
                    if not isFriend then
                        LocalPlayer:Kick("[ArcX] Friend-Only Mode: Stranger detected.")
                    end
                end
            end
        end
...
notif("ArcX loaded! Refresh & select your weapon.", 5)
print("ArcX VictUI Initialized.")

...
-- Tunggu DataService siap dulu
task.spawn(function()
    repeat task.wait(1) until Trade.DataService and Trade.ItemUtility
    ...
    tradeSection:AddButton({
        ...
        Callback = function()
            ...
            if #playerList > 0 then
                ...
                notif("Players: " .. #playerList, 2)
            else
                notif("No players online", 2)
            end
        end
    })
end)

...
local function notifToggle(name, state)
    notif(name .. ": " .. (state and "ON" or "OFF"), 2,
        state and Color3.fromRGB(90, 220, 120) or Color3.fromRGB(200, 70, 70))
end
...
-- ==================== TAB 4: KILLER ====================
local TabKILL = Window:AddTab({ Name = "Killer", Icon = "skull" })
...
-- ==================== TAB 5: MOVEMENT ====================
local TabMOVE = Window:AddTab({ Name = "Movement", Icon = "move" })
...
secSystem:AddButton({
    Title = "Unload Script",
    Callback = function()
        notif("Unloading...", 2, Color3.fromRGB(200, 70, 70))
...
local function MainLoop()
    ...
    if GUI.Drawings and GUI.Drawings.FOVCircle then
        if Config.AIM_Enabled and Config.AIM_ShowFOV then
            ...
            GUI.Drawings.FOVCircle.Color = State.AimTarget and Color3.fromRGB(90, 220, 120) or Color3.fromRGB(220, 70, 70)
...
local function Init()
    ...
    GUI.Drawings.FOVCircle.Color = Color3.fromRGB(220, 70, 70)
    ...
    GUI.Drawings.AutoGenHint.Color = Color3.fromRGB(220, 70, 70)
    GUI.Drawings.AutoGenHint.Visible = false
...
Init()
notif("Violence District Loaded!", 3, Color3.fromRGB(220, 70, 70))

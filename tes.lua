...
local function RehookForRole(role)
    ...
    task.delay(2, function()
        ...
        -- SetupSkillCheckMonitor: hook ke SkillCheckPromptGui baru
        if Config.AUTO_SkillCheck then
            pcall(SetupSkillCheckMonitor)
        end

        -- SetupAntiBlind: hook ke remote Flashlight baru
        if Config.KILLER_AntiBlind then
            pcall(SetupAntiBlind)
        end

        -- SetupNoPalletStun: hook ke remote Pallet baru
...
secESPPlayers:AddToggle({ Title = "Offscreen", Default = Config.ESP_Offscreen,
...
secESPPlayers:AddToggle({ Title = "Player Chams", Default = Config.ESP_PlayerChams,
...
secESPObjects:AddToggle({ Title = "Object Chams", Default = Config.ESP_ObjectChams,
...
secSurvival:AddToggle({ Title = "Auto Parry", Default = Config.AUTO_Parry,
    Callback = function(v) Config.AUTO_Parry = v; notifToggle("Auto Parry", v) end })
...
secSurvival:AddToggle({ Title = "Perfect Skill Check", Default = Config.AUTO_SkillCheck,
    Callback = function(v)

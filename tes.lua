...
-- ================================================================
-- PARRY FOV CIRCLE (LINGKARAN + HIGHLIGHT DI LANTAI)
-- ================================================================
...
-- Lingkaran pake Drawing.Line (biar halus)
local PFOV_N = 64
local PFOVLines = {}   -- outline putih
local PFOVFill = {}    -- fill warna (biru/merah)
...
-- Buat fill lines (tebal transparan)
for i = 1, PFOV_N do
...
local function AutoParry_Setup()
    ...
    -- Hapus panggilan CreateParryFOVCircle karena udah ga perlu
end

...
pcall(function()
    ...
    if r then
        local a = r:WaitForChild("Attacks", 5)
        if a then AttackEvent = a:WaitForChild("BasicAttack", 5) end
    end
end)
...
pcall(function()
    local r = ReplicatedStorage:WaitForChild("Remotes", 5)
    if r then
        local g = r:WaitForChild("Generator", 5)
        if g then SkillCheckRemote = g:WaitForChild("SkillCheckResultEvent", 5) end
    end
end)
...
task.spawn(function()
    ...
    if r then EmoteRemote = r:WaitForChild("EmoteHandler", 10) end
end)

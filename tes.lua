...
local function SkillCheck_Fire()
    ...
    -- Method 2: VirtualInputManager SendKeyEvent E
    pcall(function()
        local vim = game:GetService("VirtualInputManager")
        if SKILLCHECK_DEBUG then print("[SC] Method2: SendKeyEvent E") end
            ...
            if controls then
                for _, btnName in ipairs({"action", "Action", "Interact", "interact", "E", "Use"}) do
                    ...
                    if btn and btn:IsA("GuiButton") then
                        if SKILLCHECK_DEBUG then print("[SC] Method3: Click btn " .. btnName .. " in " .. gui.Name) end

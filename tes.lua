...
local function buildMonitor()
    ...
    ft.BackgroundTransparency=1 ft.Text="v38.0  •  Auto SK"
...
print("[SK] v38.0 | No Heartbeat scan | SK Manual panel")
WindUI:Notify({Title="Auto SK v38.0",Content="Loading KBBI...",Icon="zap",Duration=3})

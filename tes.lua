...
local Config = {
    ...
    SILENT_AIM_Part = "Head",  -- target part
...
secSilentAim:AddDropdown({
    ...
    Options = {"Head", "HumanoidRootPart", "UpperTorso", "LowerTorso", "Torso", "LeftUpperArm", "RightUpperArm", "LeftUpperLeg", "RightUpperLeg"},
        ...
        mt.__namecall = newcclosure(function(self, ...)
            ...
            if method == "FireServer" and self == fireRemote then
                if Config.SILENT_AIM then
                    -- FireServer(gun, direction): gun=Instance, direction=Vector3
                    local gun = select(1, ...)
                    local myRoot = LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
                    ...
                    if target and target.Character and myRoot then
                        ...
                        if aimPart then
                            ...
                            -- FireServer(gun, newDirection)
                            return oldNamecall(self, gun, dir)
                        end
                    end
                    -- Fallback: fire normal
                    return oldNamecall(self, ...)
                end
            end
            return oldNamecall(self, ...)

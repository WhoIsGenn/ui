...
local SkillCheckResultRemote = nil

local function GetSkillCheckRemote()
    if SkillCheckResultRemote and SkillCheckResultRemote.Parent then return SkillCheckResultRemote end
    local r = ReplicatedStorage:FindFirstChild("Remotes")
    local gen = r and r:FindFirstChild("Generator")
    SkillCheckResultRemote = gen and gen:FindFirstChild("SkillCheckResultEvent")
    return SkillCheckResultRemote
end

local function SkillCheck_Fire()
    -- Method 1: FireServer SkillCheckResultEvent langsung (paling reliable mobile)
    pcall(function()
    ...
    -- Method 2: CheckInterractable attribute
    pcall(function()
    ...
    -- Method 3: SendKeyEvent Space (mobile fallback)
    pcall(function()
...
local function QTE_Setup() end
local function QTE_Stop() end

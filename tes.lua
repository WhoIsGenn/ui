...
local IslandCrystals = {
    ...
    ["HollowIsland"]  = workspace:FindFirstChild("HollowIsland")       and workspace.HollowIsland:FindFirstChild("SpawnPointCrystal_Hollow"),
    ...
    ["Alx"]           = workspace:FindFirstChild("Alx")                and workspace.Alx:FindFirstChildWhichIsA("BasePart"),
    ["NinjaIsland2"]  = workspace:FindFirstChild("NinjaIsland")        and workspace.NinjaIsland:FindFirstChild("SpawnPointCrystal_Ninja2"),
}
...
task.spawn(function()
    while getgenv().celina_Running do
        ...
        -- KILL AURA (tidak equip weapon - biarkan char hold weapon sendiri)

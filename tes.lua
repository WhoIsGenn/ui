...
-- ================================================================
-- PARRY FOV CIRCLE (LINGKARAN BULAT DI BAWAH KAKI)
-- ================================================================
...
local function CreateParryFOVCircle()
    ...
    ParryFOVFill.Transparency = 0.65
...
local function UpdateParryFOV()
    ...
    -- Posisi circle di BAWAH KAKI player (Y - 2.5)
    local circlePos = root.Position + Vector3.new(0, -2.5, 0)
    ...
    if onScreen then
        ...
        if ParryOnCooldown then
            ...
            ParryFOVFill.Color = Color3.fromRGB(255, 50, 50)
            ParryFOVFill.Transparency = 0.7
        else
            ParryFOVCircle.Color = Color3.fromRGB(0, 255, 50)
            ParryFOVFill.Color = Color3.fromRGB(0, 255, 50)

...
local function buildMonitor()
    ...
    ft.BackgroundTransparency=1 ft.Text="v41.0  •  Auto SK"
...
local function rebuildList(prefix)
    ...
    for idx, word in ipairs(words) do
        ...
        -- Tombol SENT (full width kanan)
        local sentBtn=Instance.new("TextButton",row)
        sentBtn.Size=UDim2.new(0,56,0,26) sentBtn.Position=UDim2.new(1,-62,0.5,-13)
        sentBtn.BackgroundColor3=Color3.fromRGB(0,110,220) sentBtn.Text="SENT"
        sentBtn.TextColor3=Color3.fromRGB(255,255,255) sentBtn.TextSize=11
        sentBtn.Font=Enum.Font.GothamBold sentBtn.BorderSizePixel=0
        sentBtn.Active=true sentBtn.ZIndex=10
        Instance.new("UICorner",sentBtn).CornerRadius=UDim.new(0,6)
        ...
        local pilihBtn=sentBtn  -- alias agar referensi pilihBtn di SENT logic tidak error
...
local function buildManual()
    ...
    scroll.ZIndex=5 scroll.Active=true
...
print("[SK] v41.0 | No Heartbeat scan | SK Manual panel")
WindUI:Notify({Title="Auto SK v41.0",Content="Loading KBBI...",Icon="zap",Duration=3})

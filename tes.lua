...
local Tables = {
  ...
  DungeonList = {"CidDungeon", "RuneDungeon", "DoubleDungeon", "BossRush", "InfiniteTower", " Crystal Defense", "Raid Boss"},
...
-- Dungeon
S.DungJoin = Tabs.Dungeon:AddSection({ Title = "Auto Join", Open = false })
...
-- DUNGEON TAB
-- ============================================================
L(S.DungJoin, "BossRush & Infinite Tower Supported.")
D(S.DungJoin, "SelectedDungeon",   { Text = "Select Dungeon",     Values = Tables.DungeonList, Multi = false })
T(S.DungJoin, "AutoDungeon",       { Text = "Auto Join Dungeon",   Default = false })
T(S.DungJoin, "AutoInfiniteTower", { Text = "Auto Infinite Tower", Default = false })

DungeonCount = L(S.DungCfg, "Dungeon Completed: N/A")
D(S.DungCfg, "SelectedDiff",    { Text = "Select Difficulty", Values = {"Easy","Medium","Hard","Extreme"}, Multi = false })
T(S.DungCfg, "AutoDiff",        { Text = "Auto Select Difficulty", Default = false })
T(S.DungCfg, "AutoReplay",      { Text = "Auto Replay",            Default = false })
T(S.DungCfg, "DungeonAutofarm", { Text = "Autofarm Dungeon",        Default = false })

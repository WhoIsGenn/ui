local WebhookConfig = {
    ...
    ScriptName = "Victoriahub | Sailor Piece", 
    EmbedColor = 65535 
}
...
local function IsBusy()
    ...
    -- Di dalam dungeon, ForceField muncul saat spawn - jangan block
...
local _dungFarmBusy = false
local function DungeonAutofarm()
    if _dungFarmBusy then return end
    _dungFarmBusy = true

local PlaceId = game.PlaceId

if PlaceId == 138368689293913 then
    currentArea = "InfiniteTower"
elseif PlaceId == 98826438856089 then
    currentArea = "Crystal"
elseif PlaceId == 75982168454032 then
    currentArea = "Raid"
elseif PlaceId == 96767841099256 then
    currentArea = "BossRush"
elseif PlaceId == 77747658251236 or PlaceId == 130167267952199 then
    return 
...
task.spawn(function()
    while getgenv().Gennskie_Running do
        task.wait(0.1) -- lebih responsif untuk autofarm & kill aura
        ...
        if inDungeon then
            Shared.Farm = true  -- agar AutoSkill & Kill Aura jalan
            Shared.Target = getNearestDungeonTarget()
        else
            -- Jangan reset Shared.Farm di sini - biar main farm loop yang manage
        end

...
local IslandCrystals = {
    ...
    -- Tanpa crystal (pakai BasePart pertama)
    ["Lb"]           = workspace:FindFirstChild("Lb")  and workspace.Lb:FindFirstChildWhichIsA("BasePart"),
    ["HuecoMundo"]   = workspace:FindFirstChild("HuecoMundo")   and workspace.HuecoMundo:FindFirstChildWhichIsA("BasePart"),
    ["Valentine"]    = workspace:FindFirstChild("ValentineIsland") and workspace.ValentineIsland:FindFirstChildWhichIsA("BasePart"),
}
...
local Tables = {
  ...
  IslandList = {"Starter", "Jungle", "Desert", "Snow", "Sailor", "Shibuya", "HuecoMundo", "Boss", "Dungeon", "Shinjuku", "Valentine", "Slime", "Academy", "Judgement", "SoulSociety", "Tower", " Bizarre", "Slayer"},
...
SL(S.AF_Config, "SwitchWeaponCD",      { Text = "Switch Weapon Delay",  Default = 4,    Min = 1,   Max = 20,   Rounding = 0 })
...
SL(S.AF_Config, "IslandTPCD",          { Text = "Island TP CD",         Default = 0.67, Min = 0,   Max = 2.5,  Rounding = 2 })
...
D(S.AF_Config,  "SelectedFarmType",    { Text = "Select Farm Type",     Values = {"Behind","Above","Below"}, Default = "Behind" })
...
T(S.PlServer, "NoGameplayPaused", { Text = "No Gameplay Paused" })

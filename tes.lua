...
local function equipRod()
    ...
    task.wait(0.5) -- Wait untuk memastikan rod sudah ter-equip
end
...
legitFishingSection:AddToggle({
    ...
    Callback = function(v)
        ...
        if v then
            -- EQUIP ROD DULU SEBELUM MULAI FISHING
            equipRod()
...
local function lempar()
    safeCall("lempar", function()
        net["RF/RequestFishingMinigameStarted"]:InvokeServer(-139.63, 0.996, -1771532005.497,math.huge)
    end)

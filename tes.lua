...
-- ================================================================
-- PARRY FOV CIRCLE (SelectionBox BULAT di LANTAI)
-- ================================================================
...
local function UpdateParryFOV()
    ...
    -- Buat Part Cylinder kalo belum ada
    if not ParryAreaPart then
        ...
        ParryAreaPart.TopSurface = Enum.SurfaceType.Smooth
        ParryAreaPart.BottomSurface = Enum.SurfaceType.Smooth
        ParryAreaPart.Parent = workspace
    end
    
    -- Update ukuran dan posisi (di LANTAI, tepat di bawah kaki)
    local radius = Config.PARRY_Dist
    ParryAreaPart.Size = Vector3.new(radius * 2, 0.2, radius * 2)
    ParryAreaPart.CFrame = CFrame.new(root.Position.X, root.Position.Y - 3.2, root.Position.Z)
    
    -- Buat SelectionBox kalo belum ada
    if not ParryAreaHighlight then
        ParryAreaHighlight = Instance.new("SelectionBox")
        ParryAreaHighlight.Name = "_VHParryHL"
        ParryAreaHighlight.Color3 = Color3.fromRGB(0, 150, 255)  -- Biru
        ParryAreaHighlight.LineThickness = 2
        ParryAreaHighlight.SurfaceColor3 = Color3.fromRGB(0, 150, 255)
        ParryAreaHighlight.SurfaceTransparency = 0.7
        ParryAreaHighlight.Adornee = ParryAreaPart
        ParryAreaHighlight.Parent = workspace
        ParryAreaHighlight.Visible = true
    end
    
    -- Update warna (tetap biru, ga berubah)
    ParryAreaHighlight.Color3 = Color3.fromRGB(0, 150, 255)
    ParryAreaHighlight.SurfaceColor3 = Color3.fromRGB(0, 150, 255)
    ParryAreaHighlight.Visible = true
end

...
-- Di akhir script, ganti bagian LoadConfig jadi ini:
task.spawn(function()
    task.wait(1.5) 
    -- Auto load config kalo toggle enabled
    if _G.AutoLoadConfig == nil or _G.AutoLoadConfig == true then
        LoadConfigFromFile("Default")
    end
    
    -- Set isFirstLoad ke false setelah semua notif awal selesai
    getgenv().isFirstLoad = false
end)

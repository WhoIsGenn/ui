...
return function(
    ...
    function GuiFunc:AddTab(TabConfig)
        ...
        function Sections:AddSection(SectionConfig)
            ...
            SectionFrame.BackgroundTransparency = 0.96
            ...
            SectionStroke.Transparency = 0.82
            SectionStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
            SectionStroke.Parent = SectionFrame

            local Chevron
            local Divider
            local headerHeight = 6
            if SectionConfig.Title and SectionConfig.Title ~= "" then
                ...
                -- // Garis divider gradien di bawah header, melebar pas section dibuka
                Divider = Instance.new("Frame")
                Divider.Name = "Divider"
                Divider.AnchorPoint = Vector2.new(0.5, 0)
                Divider.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                Divider.BorderSizePixel = 0
                Divider.Position = UDim2.new(0.5, 0, 0, 32)
            ...
            SectionAdd.Position = UDim2.new(0, 10, 0, headerHeight)
            ...
            local function applyCollapse()
                if collapsed then
                    ...
                    if Divider then tween(Divider, { Size = UDim2.new(0, 0, 0, 1) }, 0.2) end
                else
                    ...
                    if Divider then tween(Divider, { Size = UDim2.new(1, -14, 0, 1) }, 0.2) end
                end
            end
            ...
            if Divider then Divider.Size = collapsed and UDim2.new(0, 0, 0, 1) or UDim2.new(1, -14, 0, 1) end

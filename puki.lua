...
-- YANG TADI WORK - CUMA DIEDIT Dikit
-- ================================================================
...
local function UpdateNametag(player, color, dist)
    ...
    -- FIX: BillboardGui pake Enabled, bukan Visible
    tag.Enabled = (#lines > 0)
end
...
-- ================================================================
-- PARRY FOV CIRCLE (FIXED - pake Drawing Circle)
-- ================================================================
...
local Window = VelarisUI:Window({
    ...
    Footer = "Final Fixed - All Features",
...
local secRadar = Tabs.MISC:AddSection({ Title = "Radar", Open = false })
secRadar:AddToggle({ Title = "Enable Radar", Default = Config.RADAR_Enabled, Callback = function(v) Config.RADAR_Enabled = v end })
...
secFling:AddButton({ Title = "Fling Nearest", Callback = function() end })
secFling:AddButton({ Title = "Fling All", Callback = function() end })
...
local function Init()
    ...
    -- Auto refresh when player joins/leaves

...
local function UpdateParryFOV()
    ...
    -- AMBIL TITIK DI LANTAI (bukan di badan)
    -- Cari lantai di bawah player dengan raycast
    ...
    -- Titik circle di LANTAI (Y = groundY + 0.1 biar ga nembus)
    local circlePos = Vector3.new(root.Position.X, groundY + 0.1, root.Position.Z)
    ...
    if onScreen then
        ...
        radius = math.clamp(radius, 20, 250)

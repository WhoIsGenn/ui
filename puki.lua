...
local function UpdateBossDropdowns()
    -- BossList sudah diisi dari Modules.TimedConfig di game logic
    -- Scan juga dari workspace untuk boss yang ada sekarang
        ...
        for _, obj in ipairs(npcFolder:GetDescendants()) do
            if obj:IsA("Model") then
                ...
                if hum then
                    ...
                    -- Boss = ada di MiniBossList atau nama mengandung "Boss"
...
-- Jalankan update boss dropdown setelah game load
task.spawn(function()
    task.wait(3)
    UpdateBossDropdowns()
    -- Re-scan tiap 30 detik
...
-- Brigida Multi return array {"A","B"} ATAU dict {["A"]=true}
-- ============================================================

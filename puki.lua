...
-- paste semua isi script lu di sini
...
-- taruh ini setelah load lib
print("Library:", Library)
print("ThemeManager:", ThemeManager)
...
task.spawn(function()
    ...
    if remotes then
        EmoteRemote = remotes:WaitForChild("EmoteHandler", 10)
    end
end)

-- taruh ini setelah EmoteRemote
print("EmoteRemote:", EmoteRemote)
...
local VeilAimBox = KillerTab:AddLeftGroupbox("Silent Aim Veil", "crosshair")
-- ============== HELPER =================
